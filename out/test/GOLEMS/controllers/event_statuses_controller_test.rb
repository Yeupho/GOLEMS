...
class EventStatusesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create event_status" do
    assert_difference('EventStatus.count') do
      post event_statuses_url, params: { event_status: { event_status_desc: @event_status.event_status_desc } }
    end
  ...
  test "should update event_status" do
    patch event_status_url(@event_status), params: { event_status: { event_status_desc: @event_status.event_status_desc } }
